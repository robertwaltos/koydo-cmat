...
export const metadata: Metadata = {
  title: "Pricing — Cmat Premium",
  description: "Unlock unlimited Cmat practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=cmat&cadence=annual`;
