    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6 py-20">
      <section className="text-center max-w-3xl">
        <h1 className="text-5xl font-bold tracking-tight">
          Ace the <span style={{ color: "var(--accent)" }}>CMAT</span>
        </h1>
      ...
      <footer className="mt-20 text-center text-xs text-gray-500 max-w-2xl">
        <p>CMAT is conducted by NTA. This application is an independent study tool and is not affiliated with or endorsed by NTA. All product names, logos, and brands are the property of their respective owners.</p>
      </footer>
    </main>
  );
}
