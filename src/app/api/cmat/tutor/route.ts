...
const EXAM_ID = "cmat";
const EXAM_DISPLAY_NAME = "CMAT (Common Management Admission Test)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Quantitative Techniques, Logical Reasoning, Language Comprehension, and General Awareness. Align to NTA CMAT syllabus.
