...
import { EXAM_CONFIG } from "@/lib/cmat/config";

describe("CMAT Config", () => {
  it("has correct exam ID", () => { expect(EXAM_CONFIG.examId).toBe("EXAM040"); });
  ...
  it("has correct URL", () => { expect(EXAM_CONFIG.url).toBe("https://cmat.koydo.app"); });
